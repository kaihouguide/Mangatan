...
(function() {
    ...
    function updateAllOverlays() {
        ...
        finally { if (managedElements.size > 0) requestAnimationFrame(updateAllOverlays); else { overlayUpdateRunning = false; logDebug("All overlays removed. Halting update loop."); } }
    }

    // --- BATCH, UI, Anki, and Initialization (All Unchanged) ---

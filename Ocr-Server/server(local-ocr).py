...
async def ocr_endpoint():
    ...
    try:
        ...
        if is_debug_mode:
            print(f"[DEBUG] OCR recognition finished. Found {len(all_transformed_results)} text blocks.")
...
if __name__ == '__main__':
    ...
    parser.add_argument('-D', '--debug', action='store_true', help='Enable debug mode with Flask development server.')

...
(function() {
    ...
    function calculateAndApplyOptimalStyles(overlay) {
        ...
        overlay.querySelectorAll('.gemini-ocr-text-box').forEach(box => {
            ...
            if (!text) return;
            const availableWidth = box.clientWidth + settings.boundingBoxAdjustment ; //CHANGED
            const availableHeight = box.clientHeight + settings.boundingBoxAdjustment; // CHANGED

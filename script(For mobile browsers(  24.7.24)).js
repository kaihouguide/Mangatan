...
(function() {
    ...
    function createUI() {
        ...
        GM_addStyle(`
            ...
            .gemini-ocr-decoupled-overlay .manual-highlight { opacity: 1; transform: scale(1.05); background: var(--ocr-highlight-bg-color); border-color: var(--ocr-highlight-border-color); color: var(--ocr-highlight-text-color); text-shadow: none; box-shadow: var(--ocr-highlight-shadow), var(--ocr-highlight-inset-shadow); z-index: 10000; }
